...
<header>
  ...
  <br>
<h2 align="center" style="color:#F00"><em>SignUp Here !!</em></h2>
<br>
<form action="reg_check.php" method="POST">
<table>
<tr><td>Name: <input type="text" name="firstname" size="30" required/><br></br></td></tr>
<tr><td>UserId: <input type="text" name="userid" size="30" required><br></br></td></tr>
<tr><td>Password: <input type="password" name="pass" size="30" required><br></br></td></tr> 
</table>
Gender:	<input type="radio" name="gender" value="female" required> female
        <input type="radio" name="gender" value="male" required> male
		&nbsp;&nbsp;
Date:<input name="date" size="30">
