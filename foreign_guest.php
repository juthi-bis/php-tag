...
<h2><em>Foreign Guest List</em></h2>
<br>
<?php
...
$result = mysql_query("SELECT a.Guest_id,Name,Room_no,City,Nationality FROM accomodation_guest_info as a join accomodation_guest_room as b on a.Guest_id=b.Guest_id join(SELECT Guest_id,City,Nationality FROM accomodation_guest_address WHERE Nationality!='Bangladeshi') as c on b.Guest_id=C.Guest_id");
