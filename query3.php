...
$result = mysql_query("SELECT CASE WHEN COUNT(Room_no)=10 THEN 'Not Available' ELSE 'Available' END AS Room_Availability FROM accomodation_guest_room");
