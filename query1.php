...
<h2><em>Total Num of Guest who took Newspapaper service & Total Num of Newspaper sold 10/11/16</em></h2>
<br>
<?php
...
$result = mysql_query("SELECT COUNT(DISTINCT Guest_id) AS Total_guest,SUM(Quantity) AS Item_sold from services_order WHERE Sl_no=5 and Date='10/11/16'");
